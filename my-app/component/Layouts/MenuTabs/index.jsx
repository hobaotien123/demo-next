...
const MenuTabs = ({ setPreventChangeContext }) => {
  ...
  useEffect(() => {
    document.getElementsByClassName(
      `${style.active}`
    )[0].style.color = `${context.color}`;
  }, [context]);

  const onSkillFocus = (item) => {
    setPreventChangeContext(true);
    hoverChange(item);
  };
  const onSkillLeave = () => {
    setPreventChangeContext(false);
  };
  const onClick = (item) => {
    const allTabContentNone = document.getElementsByClassName(
      `${style.tabContents}`
    );
    const allItemMenuTabNone = document.getElementsByClassName(
      `${style.itemMenuTab}`
    );
        ...
        <div className={style.leftContent}>
          <div className={style.backgroundImg}>
            <div
              ...
              style={{
                backgroundImage: "url(" + `${context.img}` + ")",
                opacity: "1",
              }}
            />
          ...
          <div className={style.profileContent}>
            ...
            <div>
              <p
                ...
                style={{ transition: "1s", color: `${context.color}` }}
              >
            ...
            <section className={style.location}>
              <div
                className={style.titleLocation}
                style={{ transition: "1s", background: `${context.color}` }}
              >
                <FontAwesomeIcon
              ...
              <div className={style.contentLocation}>HCMC / VN</div>
            </section>
          </div>
              ...
              {skills.map((item) => {
                return (
                  <div
                    key={item.id}
                    item={item}
                    onMouseOver={() => onSkillFocus(item)}
                    onMouseOut={() => onSkillLeave()}
                    className={style.framworks}
                  >
                    {item.title}
                  </div>
                );
            ...
            {contacts.map((item) => {
              return (
                ...
                >
                  <a
                    target="_blank"
                    href="https://drive.google.com/file/d/13GD6pSCickI_mGXGKpofwpkIXqDdFwfy/view?usp=sharing"
                    className={style.downloadElement}
                  >
                    {item.title}
                  </a>
                </div>
        ...
        <div className={style.rightContent}>
          <div id="about" className={style.tabContents}>
            <div
              ...
              style={{
                color: `${context.color}`,
                borderBottomColor: `${context.color}`,
              }}
            >
              ABOUT ME
            </div>
            <div className={style.myContent}>
              ...
              <div className={style.allTextContent}>
                <span className={style.textMyContent}>
                  Date of birth: &nbsp;{" "}
                </span>
              ...
              <div className={style.allTextContent}>
                ...
                <p className={style.textContent}>
                  60 C1 Street, Tân Bình District, HCMC{" "}
                </p>
              </div>
              <div className={style.allTextContent}>
                <span className={style.textMyContent}>
                ...
                <p id="fpt" className={style.textContent}>
                  I would like to become the Front-end developer with my skills
                  and myexperiences in organization and communication.
                </p>
              </div>
            </div>
          </div>
          <div id="resume" className={style.tabContents}>
            ...
            <div className={style.myContent}>
              ...
              <div className={style.year}>2017-2020</div>
            </div>
            <div className={style.myContent}>
              <div className={style.allTextContent}>
                ...
                <p className={style.textContent}>
                  {" "}
                  WEB DEVELOPER FRONT END - VNUHCM-University Of Science
            ...
            <div className={style.allMyWorks}>
              <div className={style.myWork}>
                ...
                <div className={style.contentWork}>
                  <h6 className={style.titleWork}>Portfolio</h6>
                  <a
                    target="_blank"
                    href="https://my-templates.vercel.app/?fbclid=IwAR1oh80R5bAtpdL28K2c_CMjbG0LhXJa9Rmc6pkkFKDy_qF3GmJtzpWLF6M"
                    className={style.linkWork}
                  >
                    my-templates.vercel.app
                  </a>
                  {/* <a ></a> */}
                </div>
              </div>
              <div className={style.myWork}>
                ...
                ></img>
                <div className={style.contentWork}>
                  <h6 className={style.titleWork}>Store Cakes</h6>
                  <a
                    target="_blank"
                    href="http://HOBAOTIENFE.000WEBHOSTAPP.COM"
                    className={style.linkWork}
                  >
                    hobaotienfe.000webhostapp.com
                  </a>
                  {/* <a ></a> */}
                </div>
              </div>
              <div className={style.myWork}>
                ...
                ></img>
                <div className={style.contentWork}>
                  <h6 className={style.titleWork}>Khang My</h6>
                  <a
                    target="_blank"
                    href="http://HOBAOTIENFE123.000WEBHOSTAPP.COM"
                    className={style.linkWork}
                  >
                    hobaotienfe123.000webhostapp.com
                  </a>
                </div>
              </div>
            </div>
